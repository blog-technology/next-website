...
<pre><code className="language-java">{`import jakarta.persistence.Entity;
...
<pre><code className="language-java">{`User user = entityManager.find(User.class, 1L); // Get user by ID
user.setName("Alice");
